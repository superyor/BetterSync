...
local Helpers = {
    ...
    Framework = {
        ...
        AddTab = function(self, name, varprefix)
...
local UI = {
    ...
    Init = function(self)
        ...
        lang = Helpers.json.decode(file.Read(Metadata.CurrentDirectory .. 'assets/tr/english.dat'))
        
        printTable = function(this, table)
...
local Features = {
    ...
    JumpscoutFix = {
        CreateMove = function(self, scoutfix, hitchancefix, pLocal)
    ...
    Chokeshot = {
        CreateMove = function(self, pLocal, cmd, aftershot, ticks)
...
callbacks.Register('CreateMove', function(cmd)
    ...
    Features.JumpscoutFix.CreateMove(Features, UI.Objects.ScoutFix:GetValue(), UI.Objects.HitchanceFix:GetValue(), pLocal)
    Features.Chokeshot.CreateMove(Features, pLocal, cmd, UI.Objects.ChokeshotAfter:GetValue(), UI.Objects.ChokeshotTicks:GetValue())
end)